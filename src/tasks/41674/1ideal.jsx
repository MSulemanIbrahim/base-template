...
function CalendarHeader({ date, setDate, view, setView }) {
  ...
  return (
    <div className="flex justify-between items-center mb-4">
      ...
      <Button variant="secondary" onClick={(e) => setView('daily')} value="daily">Daily</Button>
      <Button variant="secondary" onClick={(e) => setView('weekly')} value="weekly">Weekly</Button>
      <Button variant="secondary" onClick={(e) => setView('monthly')} value="monthly">Monthly</Button>
      <Button variant="secondary" onClick={() => setDate(new Date())}>Today</Button>
    </div>
  );
}
