...
const sentences = [
  ...
  { sentence: "We ___ dinner now.", options: ["have", "has", "having", "had"], correct: "are having" },
...
function Game({ questionCount }) {
  ...
  const [hintsRemaining, setHintsRemaining] = useState(questionCount <= 5 ? 2 : questionCount <= 8 ? 3 : 4);
