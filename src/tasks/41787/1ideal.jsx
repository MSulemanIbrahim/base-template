...
function App() {
  ...
  // Reset input fields and calculated BMI
  const reset = () => {
    setWeight('');
    setHeight('');
    setBMI(null);
  ...
  // Provide health tips based on BMI value
  const getHealthTips = () => {
  ...
  // Determine BMI category based on current BMI
  ...
  return (
    <div className="flex flex-col items-center p-4 sm:p-8 space-y-4 w-full max-w-lg mx-auto">
        ...
        <CardContent>
          ...
          {bmi && (
            <div className="mt-4 text-center">
              {/* Display calculated BMI and its category */}
      ...
      <Card className="mt-4 w-full">
        <CardHeader>
          {/* Toggleable section for health tips and BMI history */}
